  ...
  return (
    <div className="min-h-screen bg-[#FEF3E2] text-gray-800 font-sans selection:bg-[#FAB12F] selection:text-white">
      ...
      <main className="relative z-10 pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left relative z-10">
            ...
            <div className="flex flex-row gap-3 sm:gap-4 items-center justify-center lg:justify-start">
              ...
              <button
                ...
                className="px-4 sm:px-8 py-3 sm:py-4 bg-white text-gray-800 rounded-2xl font-mono font-bold border-2 border-[#FEF3E2] hover:border-[#FAB12F] hover:bg-[#FEF3E2] transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base cursor-pointer"
              >
        ...
        {/* How It Works */}
        <div id="how-it-works" className="mb-32 relative scroll-mt-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-6">
              ...
              <div className="flex gap-4">
                {/* Social Icons */}
                <a href="https://instagram.com/slaviors.id" className="w-10 h-10 rounded-full bg-[#FEF3E2] flex items-center justify-center text-[#FA812F] hover:bg-[#FA812F] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
            ...
            <div className="lg:col-span-3 sm:col-span-6">
              <h4 className="font-mono font-bold text-gray-900 mb-6">Features</h4>
              <ul className="space-y-4">
                {['AI Food Scanner', 'Calorie Counter', 'Macro Tracker'].map((item) => (
                  <li key={item}>
                    <Link href="/auth/login" className="text-gray-500 hover:text-[#FA812F] transition-colors font-medium text-sm flex items-center gap-2 group">
            ...
            <div className="lg:col-span-3 sm:col-span-6">
              <h4 className="font-mono font-bold text-gray-900 mb-6">Resources</h4>
              <ul className="space-y-4">
                {['Nutrition Blog', 'Healthy Recipes'].map((item) => (
                  <li key={item}>
                    <Link href="/auth/login" className="text-gray-500 hover:text-[#FA812F] transition-colors font-medium text-sm flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#FAB12F] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                      {item}
          ...
          <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400 font-medium">
              &copy; 2025 Slaviors. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
