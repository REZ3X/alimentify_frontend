...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#FEF3E2] px-4 relative overflow-hidden font-sans selection:bg-[#FAB12F] selection:text-white">
            ...
            {/* Decorative Blobs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#FAB12F]/20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#FA812F]/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="bg-white/60 backdrop-blur-xl border border-white/50 rounded-[2rem] shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] p-8 md:p-10">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-mono font-bold text-gray-900 mb-3">Create Account</h1>
                        <p className="text-gray-600">Join Alimentify today and start eating smarter</p>
                    </div>
                    ...
                    <div className="mt-8 p-4 bg-[#FEF3E2]/50 border border-[#FAB12F]/20 rounded-2xl">
                        <div className="flex gap-3">
                            <div className="w-8 h-8 bg-[#FAB12F] rounded-full flex items-center justify-center flex-shrink-0 text-white shadow-sm">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <div>
                                <p className="text-sm text-gray-900 font-bold font-mono">Email Verification</p>
